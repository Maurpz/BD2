...
//     // Demostración de la funcionalidad get
//     try {
//         CTID c = tree.get(44);
//         cout << "\nget(44): numBlock = " << c.numBlock << ", offsetTuple = " << c.offsetTuple << "\n";
//     } catch (exception &e) {
//         cout << "\nError: " << e.what() << "\n";
//     }

//     // Demostración de la funcionalidad update
//     try {
//         CTID newA1 = {55, 5555};
//         tree.update(44, newA1);
//         cout << "\nDespués de update(44, {55, 5555}):\n";
//         tree.print();

//         CTID newA2 = {77, 7777};
//         tree.update(4, newA2);
//         cout << "\nDespués de update(4, {77, 7777}):\n";
//         tree.print();
//     } catch (exception &e) {
//         cout << "\nError: " << e.what() << "\n";
//     }

//     // Intentar actualizar una clave que no existe
//     try {
//         CTID newA3 = {99, 9999};
//         tree.update(100, newA3);
//     } catch (exception &e) {
//         cout << "\nError al actualizar clave 100: " << e.what() << "\n";
//     }
